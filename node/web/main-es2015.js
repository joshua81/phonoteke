...
/* harmony import */ var _docs_menu_menu_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./docs/menu/menu.component */ "./src/app/docs/menu/menu.component.ts");
...
/* harmony import */ var _doc_menu_menu_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./doc/menu/menu.component */ "./src/app/doc/menu/menu.component.ts");
/* harmony import */ var _doc_doc_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./doc/doc.component */ "./src/app/doc/doc.component.ts");
/* harmony import */ var _youtube_youtube_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./youtube/youtube.component */ "./src/app/youtube/youtube.component.ts");
/* harmony import */ var _doc_events_events_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./doc/events/events.component */ "./src/app/doc/events/events.component.ts");
/* harmony import */ var _angular_youtube_player__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @angular/youtube-player */ "./node_modules/@angular/youtube-player/esm2015/youtube-player.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _docs_menu_menu_component__WEBPACK_IMPORTED_MODULE_9__["DocsMenuComponent"],
            _docs_docs_component__WEBPACK_IMPORTED_MODULE_10__["DocsComponent"],
            _doc_menu_menu_component__WEBPACK_IMPORTED_MODULE_11__["DocMenuComponent"],
            _doc_doc_component__WEBPACK_IMPORTED_MODULE_12__["DocComponent"],
            _youtube_youtube_component__WEBPACK_IMPORTED_MODULE_13__["YoutubeComponent"],
            _doc_events_events_component__WEBPACK_IMPORTED_MODULE_14__["EventsComponent"]
        ],
        imports: [
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot([
                { path: '', component: _docs_docs_component__WEBPACK_IMPORTED_MODULE_10__["DocsComponent"] },
                { path: 'docs', component: _docs_docs_component__WEBPACK_IMPORTED_MODULE_10__["DocsComponent"] },
                { path: 'docs/:docId', component: _doc_doc_component__WEBPACK_IMPORTED_MODULE_12__["DocComponent"] }
            ]),
...
let DocsComponent = class DocsComponent {
    ...
    loadDocs(page, docType) {
        ...
        this.http.get('/api/docs?p=' + this.page + '&q=' + this.searchText + '&t=' + this.docType).subscribe((data) => this.docsLoaded(data), error => this.error = error);
    }
    docsLoaded(data) {
    ...
    loadTracks(page) {
        ...
        this.http.get('/api/tracks?p=' + this.page + '&q=' + this.searchText).subscribe((data) => this.tracksLoaded(data), error => this.error = error);
    }
    tracksLoaded(data) {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], YoutubeComponent.prototype, "tracks", void 0);
