...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppSectionSectionComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div *ngIf=\"docs && docs.length != 0\" class=\"container pl-1 pr-1 mt-3\">\n  <div class=\"d-flex flex-row align-items-center pl-0 pr-0\">\n    <h1 class=\"text-uppercase mt-0 mb-0 mr-auto\">{{label}}</h1>\n    <div *ngIf=\"component.isDesktop()\"\n      class=\"backward\" (click)=\"previous()\"><span class=\"previous\"></span></div>\n    <div *ngIf=\"component.isDesktop()\"\n      class=\"forward\" (click)=\"next()\"><span class=\"next\"></span></div>\n  </div>\n  <div id=\"{{type}}\" infinite-scroll class=\"d-flex flex-row flex-nowrap hscroll pt-2\" \n    [horizontal]=\"true\" [scrollWindow]=\"false\" (scrolled)=\"scrollDocs()\">\n      <div *ngFor=\"let doc of docs\" class=\"pr-2\">\n        <div class=\"cover card\">\n          <a class=\"cover\" [routerLink]=\"['/docs/' + doc.id]\">\n            <img *ngIf=\"doc.coverM == null\" class=\"cover card-img-top\" src=\"{{doc.cover}}\"/>\n            <img *ngIf=\"doc.coverM != null\" class=\"cover card-img-top\" src=\"{{doc.coverM}}\"/>\n          </a>\n          <div *ngIf=\"doc.description != null\" class=\"card-body p-1\">\n            <h2 *ngIf=\"doc.type != 'artist'\" class=\"text-truncate-2\" [innerHTML]=\"doc.title\"></h2>\n            <h3 *ngIf=\"doc.type != 'artist'\" class=\"text-truncate-2\" [innerHTML]=\"doc.artist\"></h3>\n            <h2 *ngIf=\"doc.type == 'artist'\" class=\"text-truncate-2\" [innerHTML]=\"doc.artist\"></h2>\n            <p class=\"text-truncate-4 pt-2\" [innerHTML]=\"doc.description\"></p>\n          </div>\n          <div *ngIf=\"doc.description == null\" class=\"card-body-sm p-1\">\n            <h2 *ngIf=\"doc.type != 'artist'\" class=\"text-truncate-2\" [innerHTML]=\"doc.title\"></h2>\n            <h3 *ngIf=\"doc.type != 'artist'\" class=\"text-truncate-2\" [innerHTML]=\"doc.artist\"></h3>\n            <h2 *ngIf=\"doc.type == 'artist'\" class=\"text-truncate-2\" [innerHTML]=\"doc.artist\"></h2>\n          </div>\n        </div>\n      </div>\n  </div>\n</div>\n";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot([//{path: '', component: DocsComponent},
      {
        path: '',
  ...
  function srcAppSectionSectionComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".backward {\n  width: 40px;\n  height: 20px;\n  cursor: pointer;\n}\n\n.previous {\n  display: inline-block;\n  -webkit-mask: url(\"/images/previous.svg\");\n          mask: url(\"/images/previous.svg\");\n  width: 10px;\n  height: 15px;\n  margin-top: 2px;\n  margin-left: 20px;\n  background: #18A2B8;\n  cursor: pointer;\n}\n\n.forward {\n  width: 40px;\n  height: 20px;\n  background: none;\n  cursor: pointer;\n}\n\n.next {\n  display: inline-block;\n  -webkit-mask: url(\"/images/next.svg\");\n          mask: url(\"/images/next.svg\");\n  width: 10px;\n  height: 15px;\n  margin-top: 2px;\n  margin-left: 20px;\n  background: #18A2B8;\n  cursor: pointer;\n}\n\ndiv.cover {\n  width: 200px;\n  position: relative;\n}\n\na.cover {\n  width: 200px;\n  height: 200px;\n}\n\nimg.cover {\n  width: 200px;\n  height: 200px;\n  -o-object-fit:cover;\n     object-fit:cover;\n}\n\n.card {\n  border-style: none;\n}\n\n.card-body {\n  position: relative;\n  width: 200px;\n  height: 150px;\n}\n\n.card-body-sm {\n  position: relative;\n  width: 200px;\n  height: 80px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppSectionSectionComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _docs_docs_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../docs/docs.component */
    "./src/app/docs/docs.component.ts");
    ...
    SectionComponent.ctorParameters = function () {
      return [{
        type: _docs_docs_component__WEBPACK_IMPORTED_MODULE_2__["DocsComponent"]
      }];
    };
