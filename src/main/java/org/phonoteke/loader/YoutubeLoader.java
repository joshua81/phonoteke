...
public class YoutubeLoader extends PhonotekeLoader
{
	...
	public void loadTracks()
	{
		try
		{
			...
			MongoCursor<org.bson.Document> i = docs.find(Filters.and(Filters.eq("type", "album"), Filters.ne("tracks", null))).sort(new BasicDBObject("date", OrderBy.DESC.getIntRepresentation())).limit(1200).noCursorTimeout(true).iterator();
			while(i.hasNext())
			{
