...
/**
 * Test class for NTSCrawler
 * Tests the core functionality of crawling NTS episodes and extracting playlists
 */
@Slf4j
public class NTSCrawlerTest {
	...
	void testCrawlEpisode() {
		try {
			NTSCrawler crawler = new NTSCrawler(null);
			crawler.setId(TEST_EPISODE_URL);
			HBDocument result = crawler.crawlDocument(TEST_EPISODE_URL, (JsonObject)null);
